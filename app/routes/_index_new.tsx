    ...
    <div className="min-h-screen oxford-blue-space flex items-center justify-center p-4 animate-fade-in relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl animate-slide-in-up relative z-10">
        ...
        <div className="space-y-6">
          ...
          <Link
            to="/login/student"
            className="block w-full bg-white/10 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 glass-effect p-8 hover:bg-white/15 transition-all duration-300 group transform hover:scale-105"
            style={{boxShadow: '0 8px 32px rgba(0,0,0,0.3), 0 0 40px rgba(255,255,255,0.1)'}}
          >
            <div className="flex items-center space-x-6">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-2xl flex items-center justify-center shadow-2xl group-hover:shadow-blue-400/50 transition-all duration-300 glow-effect">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-300 transition-colors" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.5)'}}>
                  Student Login
                </h3>
                <p className="text-blue-200 leading-relaxed" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.3)'}}>
                  Access your student portal with register number and password
                </p>
              </div>
              <div className="text-blue-400 group-hover:text-blue-300 transition-colors transform group-hover:translate-x-2 duration-300">
          ...
          >
            <div className="flex items-center space-x-6">
              <div className="w-16 h-16 bg-gradient-to-r from-emerald-400 to-green-500 rounded-2xl flex items-center justify-center shadow-2xl group-hover:shadow-emerald-400/50 transition-all duration-300 glow-effect">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-emerald-300 transition-colors" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.5)'}}>
                  Admin Login
                </h3>
                <p className="text-blue-200 leading-relaxed" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.3)'}}>
        ...
        <div className="text-center mt-12">
          <p className="text-sm text-blue-300/60" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.5)'}}>
